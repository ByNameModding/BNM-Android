...
namespace BNM::Structures::Unity {
    ...
    struct Color {
        ...
        inline Color(float r, float g, float b) : r(r), g(g), b(b), a(255) {}
        ...
        inline static Color random(float a = 255.f) {
            float r = (float)rand() / 255.f;
            float g = (float)rand() / 255.f;
            float b = (float)rand() / 255.f;
            return {r, g, b, a};
        }
        [[nodiscard]] inline Color ToMono() const { return {r / 255.f, g / 255.f, b / 255.f, a / 255.f }; }
