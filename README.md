...
class LoadClass {
	...
	void *CreateNewClass(void **args, int args_count); // In mono: new className();
}
template<typename T>
...
Il2CppReflectionType *GetMonoTypeFromIl2CppClass(Il2CppClass *klass); // Can be used for GameObject.AddComponent or GetComponent
