...
namespace BNM {
    namespace UNITY_STRUCTS {
        ...
        struct Vector4 {
            ...
            inline static bool CompareApproximately(const Vector4& inV0, const Vector4& inV1, const float inMaxDist = Vector3::epsilon);
        ...
        inline bool Vector4::IsFinite(const Vector4& f) { return UNITY_STRUCTS::IsFinite(f.x) & UNITY_STRUCTS::IsFinite(f.y) & UNITY_STRUCTS::IsFinite(f.z) && UNITY_STRUCTS::IsFinite(f.w); }
